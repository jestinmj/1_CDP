...
- [A Full Enterprise Grade DevSecOps Pipelines (Optional)](#a-full-enterprise-grade-devsecops-pipelines)
...
> Please click on the **Start the Exercise** button, as it will take **1-2 minutes** for the GitLab machine to start.
...
Please explore the [Certified DevSecOps Expert (CDE) Course](https://www.practical-devsecops.com/certified-devsecops-expert/) for learning advanced DevSecOps practices including custom rulesets, authenticated DAST scans, Threat Modelling as Code and much more.
